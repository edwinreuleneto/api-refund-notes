...
```bash
AWS_ACCESS_KEY_ID_INTERNAL=your-access-key
AWS_SECRET_ACCESS_KEY_INTERNAL=your-secret-key
AWS_ACCESS_BUCKET_INTERNAL=your-bucket-name
AWS_REGION_INTERNAL=us-east-1
S3_FOLDER=cupons
